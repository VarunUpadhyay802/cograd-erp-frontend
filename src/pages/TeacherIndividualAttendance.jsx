...
const TeacherIndividualAttendance = () => {
  ...
  const handleStatusChange = async (teacherId, status) => {
    ...
    try {
      await axios.post("http://localhost:4000/teacherReg/editAttendance", attendanceData, {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <h2 className="text-xl font-semibold mb-4">Record Individual Teacher Attendance</h2>
